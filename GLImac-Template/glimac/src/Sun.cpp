...
namespace glimac{
    ...
    void Sun::initPlanets(char* path){
        ...
        Moon* moon = new Moon(path,"Moon",pathMoon,384400.0f,0.0549f,3475.0f,5.145f,12756.0f);
        Moon* Phobos = new Moon(path,"Phobos",pathMoon,9378.0f,0.0151f,22.5f,1.08f,6792.0f);
        Moon* Demios = new Moon(path,"Demios",pathMoon,23459.0f,0.0005f,12.0f,1.79f,6792.0f);
        Moon* Callisto = new Moon(path,"Callisto",pathMoon,1882710.0f,0.007f,4821.0f,0.19f,142984.0f);
        Moon* Ganymede = new Moon(path,"Ganymede",pathMoon,1070410.0f,0.001f,5262.0f,0.18f,142984.0f);
        Moon* Europa = new Moon(path,"Europa",pathMoon,671030.0f,0.009f,3122.0f,0.47f,142984.0f);
        Moon* Io = new Moon(path,"Io",pathMoon,421700.0f,0.004f,3643.0f,0.04f,142984.0f);
        Moon* Mimas = new Moon(path,"Mimas",pathMoon,185520.0f,0.0202f,392.0f,1.53f,120536.0f);
        Moon* Enceladus = new Moon(path,"Enceladus",pathMoon,238020.f,0.0045f,498.0f,0.0f,120536.0f);
        Moon* Tethys = new Moon(path,"Tethys",pathMoon,294660.0f,0.0f,1060.0f,1.86f,120536.0f);
        Moon* Dione = new Moon(path,"Dione",pathMoon,377400.0f,0.0022f,1120.0f,0.02f,120536.0f);
        Moon* Rhea = new Moon(path,"Rhea",pathMoon,527040.0f,0.0010f,1530.0f,0.35f,120536.0f);
        Moon* Titan = new Moon(path,"Titan",pathMoon,1221830.0f,0.0292f,5150.0f,0.33f,120536.0f);
        Moon* Hyperion = new Moon(path,"Hyperion",pathMoon,1481100.0f,0.1042f,286.0f,0.43f,120536.0f);
        Moon* Iapetus = new Moon(path,"Iapetus",pathMoon,3561300.0f,0.0283f,1460.0f,14.72f,120536.0f);
        Moon* Ariel = new Moon(path,"Ariel",pathMoon,199900.0f,0.0012f,1158.0f,0.04f,51118.0f);
        Moon* Umbriel = new Moon(path,"Umbriel",pathMoon,266000.0f,0.0039f,1169.0f,0.13f,51118.0f);
        Moon* Titania = new Moon(path,"Titania",pathMoon,436300.0f,0.0011f,1577.0f,0.08,51118.0f);
        Moon* Oberon = new Moon(path,"Oberon",pathMoon,583500.0f,0.0014,1523.0f,0.07f,51118.0f);
        Moon* Miranda = new Moon(path,"Miranda",pathMoon,129900.0f,0.0013,472.0f,4.34f,51118.0f);
        Moon* Triton = new Moon(path,"Triton",pathMoon,354760.0f,0.000016f,2707.0f,157.345f,49528.0f);
